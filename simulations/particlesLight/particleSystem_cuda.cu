...
extern "C"
{
                         ...
                         EventTimer* timer)
    {
        ...
        thrust::for_each(
            thrust::make_zip_iterator(thrust::make_tuple(pos4, vel4, force4)),
            thrust::make_zip_iterator(thrust::make_tuple(pos4+numParticles, 
                                                         vel4+numParticles, 
                                                         force4+numParticles)),
            integrate_functor(deltaTime, shouldResort));
